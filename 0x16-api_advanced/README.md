The following codes are for ALX 0x16-api_advanced project for the alx-system_engineering-devops project, inside it contains the following python scripts:
